...
function App() {
  const storyList = [
    ...
    {id: 7, title: "The Man Upstairs", image: upstairs, text: "Grandma ladled liberal portions from the chicken’s interior. Douglas watched, thinking about how that chicken had had two kinds of guts—God-made and Man-made. Well, how about three kinds of guts? Eh? Why not?"},
